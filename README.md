...
> Проектот е изработен како факултетска задача — дизајн на дигитално решение за тема поврзана со адолесцентно здравје од HBSC извештајот.
...
- Чист **HTML / CSS / JavaScript** — без фрејмворци, без бекенд, без надворешни зависности
- Целосно клиентска апликација — работи директно во прелистувач, само со отворање на `index.html`
- Google Fonts: **Unbounded** (наслови) и **Inter** (текст), со целосна кириличка поддршка

## 🚀 Стартување локално

Не е потребна инсталација. Само:

```bash
git clone https://github.com/<твое-корисничко-име>/vnatresna-svetlina.git
cd vnatresna-svetlina
```

и отвори го `index.html` во прелистувач (двоен клик, или преку live server екстензија за развој).
...
Изработено со 🤍 како дел од факултетски проект за адолесцентно здравје и добросостојба.
